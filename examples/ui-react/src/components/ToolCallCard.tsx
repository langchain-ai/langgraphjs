...
import type { InferAgentToolCalls, ToolCallWithResult, ToolCallFromTool } from "@langchain/langgraph-sdk/react";
import type { agent, getWeather } from "../agent.mjs";
...
export function ToolCallCard({
  ...
  toolCall: ToolCallWithResult<InferAgentToolCalls<typeof agent>>;
}) {
