...
const TABS: Array<{
  ...
  },
  {
    ...
    blurb: "createAgent workflow that pauses on a sensitive tool call for review.",
  },
];
  ...
  return (
    <main className="app-shell">
      <header className="app-header">
        <div>
          ...
          <p className="app-subtitle">
            ...
            patterns, and a human-in-the-loop approval flow while the frontend
            streams through the standard legacy API, the new session-based HTTP
            +SSE protocol, or the new WebSocket protocol.
          </p>
        </div>
      ...
      {activeTab === "human-in-the-loop" ? (
        <HumanInTheLoopView key={activeViewKey} transportMode={transportMode} />
      ) : null}
    </main>
  );
}
