...
REDIRECT_MAP = {
    ...
    "quickstart.md": "https://docs.langchain.com/oss/javascript/langgraph/quickstart",
...
<head>
    ...
    <script>
        ...
        window.location.href = "https://docs.langchain.com/oss/javascript/langgraph/overview";
    </script>
    <meta http-equiv="refresh" content="0; url=https://docs.langchain.com/oss/javascript/langgraph/overview">
</head>
<body>
<h1>Page Not Found</h1>
<p>This page has moved to the new LangGraph.js documentation at <a href="https://docs.langchain.com/oss/javascript/langgraph/overview">docs.langchain.com</a>.</p>
<p>Redirecting you now...</p>
</body>
</html>
"""
