...
REDIRECT_MAP = {
    ...
    "tutorials/deployment.md": "https://docs.langchain.com/langsmith/deployment-options",
    "tutorials/langsmith/local-server.md": "https://docs.langchain.com/langsmith/local-server",
    "concepts/template_applications.md": "https://docs.langchain.com/oss/javascript/langgraph/template-applications",
    ...
    "how-tos/time-travel.ipynb": "https://docs.langchain.com/oss/javascript/langgraph/time-travel",
    ...
    "how-tos/tool-calling.ipynb": "https://docs.langchain.com/oss/javascript/langgraph/tools",
    "how-tos/force-calling-a-tool-first.ipynb": "https://docs.langchain.com/oss/javascript/langgraph/tools",
    "how-tos/tool-calling-errors.ipynb": "https://docs.langchain.com/oss/javascript/langgraph/tools",
    "how-tos/pass-run-time-values-to-tools.ipynb": "https://docs.langchain.com/oss/javascript/langgraph/tools",
    "how-tos/update-state-from-tools.ipynb": "https://docs.langchain.com/oss/javascript/langgraph/tools",
    "how-tos/subgraph.ipynb": "https://docs.langchain.com/oss/javascript/langgraph/subgraphs",
    "how-tos/subgraphs-manage-state.ipynb": "https://docs.langchain.com/oss/javascript/langgraph/subgraphs",
    "how-tos/subgraph-transform-state.ipynb": "https://docs.langchain.com/oss/javascript/langgraph/subgraphs",
    "how-tos/multi-agent-network.ipynb": "https://docs.langchain.com/oss/javascript/langgraph/multi-agent-supervisor",
    "how-tos/multi-agent-network-functional.ipynb": "https://docs.langchain.com/oss/javascript/langgraph/multi-agent-supervisor",
    "how-tos/multi-agent-multi-turn-convo.ipynb": "https://docs.langchain.com/oss/javascript/langgraph/multi-agent-supervisor",
    "how-tos/multi-agent-multi-turn-convo-functional.ipynb": "https://docs.langchain.com/oss/javascript/langgraph/multi-agent-supervisor",
    ...
    "cloud/how-tos/invoke_studio.md": "https://docs.langchain.com/langsmith/invoke-studio",
    "cloud/how-tos/threads_studio.md": "https://docs.langchain.com/langsmith/threads-studio",
    "cloud/how-tos/datasets_studio.md": "https://docs.langchain.com/langsmith/datasets-studio",
    ...
    "concepts/agentic_concepts.md": "https://docs.langchain.com/oss/javascript/langgraph/agentic-architectures",
    "concepts/multi_agent.md": "https://docs.langchain.com/oss/javascript/langgraph/multi-agent-supervisor",
    ...
    "concepts/langgraph_platform.md": "https://docs.langchain.com/langsmith/index",
    "concepts/deployment_options.md": "https://docs.langchain.com/langsmith/deployment-options",
    "concepts/plans.md": "https://docs.langchain.com/langsmith/plans",
    "concepts/langgraph_server.md": "https://docs.langchain.com/langsmith/langgraph-server",
    "concepts/langgraph_studio.md": "https://docs.langchain.com/langsmith/langgraph-studio",
    ...
    "tutorials/multi_agent/multi_agent_collaboration.ipynb": "https://docs.langchain.com/oss/javascript/langgraph/multi-agent-supervisor",
    "tutorials/multi_agent/agent_supervisor.ipynb": "https://docs.langchain.com/oss/javascript/langgraph/multi-agent-supervisor",
    "tutorials/multi_agent/hierarchical_agent_teams.ipynb": "https://docs.langchain.com/oss/javascript/langgraph/multi-agent-supervisor",
    ...
    "tutorials/chatbot-simulation-evaluation/agent-simulation-evaluation.ipynb": "https://docs.langchain.com/oss/javascript/langgraph/evaluations",
    ...
    "agents/run_agents.md": "https://docs.langchain.com/oss/javascript/langgraph/run-an-agent",
    "agents/streaming.md": "https://docs.langchain.com/oss/javascript/langgraph/streaming",
    "agents/models.md": "https://docs.langchain.com/oss/javascript/langgraph/models",
    "agents/tools.md": "https://docs.langchain.com/oss/javascript/langgraph/tools",
    "agents/mcp.md": "https://docs.langchain.com/oss/javascript/langgraph/mcp",
    ...
    "agents/multi-agent.md": "https://docs.langchain.com/oss/javascript/langgraph/multi-agent-supervisor",
