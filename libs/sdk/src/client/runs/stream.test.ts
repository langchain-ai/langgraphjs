...
describe("Client streaming with retry", () => {
  ...
  describe("runs.stream()", () => {
    ...
    test("can opt into protocol SSE streaming", async () => {
      mockFetch.mockResolvedValueOnce(
        new Response(
          JSON.stringify({
            type: "success",
            ...
            },
            {
              ...
              data: {
                ...
                params: {
                  namespace: [],
                  timestamp: Date.now(),
                  data: { messages: [{ id: "msg-1", type: "ai", content: "Hello" }] },
                },
              },
            },
          ]),
        ...
        expect.arrayContaining([
          ...
          expect.objectContaining({
            ...
            data: [
              ...
              expect.objectContaining({ model_name: "fake" }),
            ],
          }),
          expect.objectContaining({
            event: "values",
            data: {
              messages: [{ id: "msg-1", type: "ai", content: "Hello" }],
            },
          }),
        ]),
      );
