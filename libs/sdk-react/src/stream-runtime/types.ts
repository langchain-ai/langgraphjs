...
import type { EventStreamEvent, RunCallbackMeta } from "@langchain/langgraph-sdk/ui";
import type { SubmitOptions } from "../types.js";

export interface StreamRuntimeSubmitArgs<
...
export interface StreamRuntimeJoinArgs {
  threadId: string;
  runId: string;
  signal: AbortSignal;
  lastEventId?: string;
...
> {
  ...
  ): Promise<AsyncGenerator<{ id?: string; event: StreamEvent; data: unknown }>>;
}
