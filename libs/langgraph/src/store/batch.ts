import { BaseStore, V } from "./base.js";
...
interface PutOp {
  writes: Array<[string, string, V | null]>;
}
...
export class AsyncBatchedStore extends BaseStore {
   ...
   * @returns {Promise<Record<string, Record<string, V>>>} A promise that resolves with the list results.
   */
   ...
   * @param {Array<[string, string, V | null]>} writes An array of write operations to be performed.
