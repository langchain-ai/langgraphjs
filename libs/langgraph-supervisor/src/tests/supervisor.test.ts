...
describe("Test supervisor basic workflow", () => {
  it("basic supervisor workflow", async () => {
    ...
    // In TypeScript version, we don't have the withAgentName utility function
    // So we'll simulate it with conditional param handling
    ...
    expect(resultFullHistoryObj.messages[3]).toEqual(researchAgentMessages[0]);
    expect(resultFullHistoryObj.messages[5]).toEqual(researchAgentMessages[1]);
