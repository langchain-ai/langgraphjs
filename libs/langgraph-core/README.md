...
For an equivalent Python library, check out [LangGraph](https://github.com/langchain-ai/langgraph) and the [JS docs](https://docs.langchain.com/oss/python/langgraph/overview).
